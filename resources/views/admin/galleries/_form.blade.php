...
<div class="form-group">
    ...
    >
    <small class="form-text text-muted">Format: JPG, PNG, WEBP. Maks: 2MB. @if(isset($gallery)) Kosongkan jika tidak ingin mengubah gambar. @endif</small>
    @error('image')
        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
    @enderror
</div>
...
<div class="form-group">
    ...
    <textarea
        ...
        rows="4"
        placeholder="Ceritakan sedikit tentang foto atau event ini"
