<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6">
        <nav class="space-y-1">
            ...
            <a href="{{ route('user.conversations.index') }}"
                class="block px-4 py-2 text-sm font-medium rounded-md
              {{ request()->routeIs('user.conversations.*') ? 'bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700' }}">
                <i class="fas fa-envelope w-6 mr-2 inline-block text-center"></i>
                Pesan Saya
            </a>
