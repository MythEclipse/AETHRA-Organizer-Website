...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <header class="header">
        ...
        <a href="#" class="logo aeo(3).png"><span>A</span>ETHRA ORGANIZER</a>
    ...
    <section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <h3>contact info</h3>
                <a href="#"> <i class="fas fa-phone"></i> +62 821-2072-2442 (General Manager) </a>
                <a href="#"> <i class="fas fa-phone"></i> +62 857-2263-6187 (Sales Manager) </a>
                <a href="#"> <i class="fas fa-envelope"></i> aethraorganizer@gmail.com </a>
                <a href="#"> <i class="fas fa-envelope"></i> aethraorganizer@gmail.com </a>
                <a href="#"> <i class="fas fa-map-marker-alt"></i> Indonesia, Panorama Asri 45510 </a>
            </div>
        ...
        <div class="credit"> Copyright© <span>AETHRA ORGANIZER</span> | all rights reserved </div>
